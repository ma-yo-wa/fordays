...
-- ---------------------------------------------------------------------
-- 3. ENQUEUE
--    Shared async POST to the Edge Function. Never blocks the write.
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 5. JOIN FAN-OUT
--    Open seat fills (partner_2_id null → set). Ping the person who was
--    already waiting — never the joiner.
-- ---------------------------------------------------------------------
